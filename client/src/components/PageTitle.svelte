...
<div
  ...
  title="{isIndex ? '' : 'Back'}"
  on:click="{() => {
    if (isIndex === false) pop();
  }}"
>
  {#if isIndex === false}
    <svg
      class="inline-block w-4 h-4 mb-2 mr-2 fill-current"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 492 492"
    >
      <path
        d="M198.608 246.104L382.664 62.04c5.068-5.056 7.856-11.816 7.856-19.024
  ...
  {/if}
  <h1
    class="inline-block font-sans text-xl font-semibold cursor-pointer select-none"
  >
    {title}
  </h1>
</div>
